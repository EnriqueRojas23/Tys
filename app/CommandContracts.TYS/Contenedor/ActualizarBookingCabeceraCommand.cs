...
{
    public class ActualizarBookingCabeceraCommand : Command
    {
        ...
        public IList<ActualizarBookingDetalleCommand> LIstabookingDetalle { get; set; }

    }

    public class ActualizarBookingDetalleCommand
    {
