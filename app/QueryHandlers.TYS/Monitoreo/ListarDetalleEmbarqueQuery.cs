...
{
    public class ListarDetalleEmbarqueQuery : IQueryHandler<ListarDetalleEmbarqueParameters>
    {

        public QueryResult Handle(ListarDetalleEmbarqueParameters parameters)
        {
            using(var connection = (SqlConnection)ConnectionFactory.CreateFromSecuritySession())
            {
                ...
                var resultado = new ListarDetalleEmbarqueResults
                {
                    Hits = connection.Query<ListarDetalleEmbarqueDto>
                    (
                       "monitoreo.pa_listadetalleembarque",
                       parametros,
