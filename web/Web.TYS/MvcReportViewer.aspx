...
<head runat="server">
    ...
    <script src="~/Scripts/MvcReportViewer.js" type="text/javascript"></script>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer" ShowToolBar="true" ShowParameterPrompts="false" ClientIDMode="Predictable" runat="server"></rsweb:ReportViewer>
    </div>
    </form>
