        ...
        for (var i = 0, len = s.columns.length;i<len;i++) {
            ...
            gs.gridcols.push(i);
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {font-family:Verdana,Arial,sans-serif; border-style: solid;border-width: 0.1em;border-color:#DDDDDD;font-size:0.9em;vertical-align: top ; text-align: left ; overflow:hidden;margin-left:0;position:relative;width: 100%;padding-left:7px;white-space: nowrap;}',
						...
						'.jstree-grid-header-cell {overflow: hidden; padding: 5px 5px 5px 5px; cursor: default; white-space : normal !important; height: 35px;font: bold 10px/30px Verdana, Arial,sans-serif; text-align:center ;boder-style:0.5px solid #ddd}',
						'.jstree-grid-header-themeroller {border: 1; padding: 1px 3px;}',
                        '.jstree-grid-header-regular {font-size:9.5px;font-weight: bold;border-style: solid;border-width: 0.5px;border-color:#DDDDDD;position:relative; background-color: #F9F9F9; z-index: 1;}',
                        '.jstree-grid-hidden {display: none;}',
						'.jstree-grid-resizable-separator {cursor: col-resize; width: 2px;}',
						'.jstree-grid-separator-regular {border-color: #f3efef; border-top : 0 none;border-bottom : 0 none ;border-style: solid; text-align : center; height: 35px}',
						'.jstree-grid-cell-themeroller {border: 1 !important; background: transparent !important;}',
