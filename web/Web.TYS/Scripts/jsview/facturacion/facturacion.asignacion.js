...
$(document).ready(function () {
 ...
 $("#btnBuscar").button()
                  ...
                  var vdataurl =  UrlHelper.Action("JsonGetListarAsignaciones", "Facturacion", "Facturacion") + "?criterio=" + criterio;
...
{
   var url = UrlHelper.Action("EliminarAsignacion", "Facturacion", "Facturacion");
    swal({
...
function exportarReporte() {
        var criterio = $('#razonsocial').val();
     var vdataurl =  UrlHelper.Action("ExportarAsignacion", "Facturacion", "Facturacion") +  "?criterio=" + criterio ;
