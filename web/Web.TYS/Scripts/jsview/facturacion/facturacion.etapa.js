...
function btnBuscarDocumento_onclick(obj, event) {
    ...
    var url = UrlHelper.Action("AgregarEtapaModal", "Facturacion", "Facturacion")
...
{
    var url = UrlHelper.Action("EditarEtapaModal", "Facturacion", "Facturacion") + "?id=" + id;
...
{
    var vUrl = UrlHelper.Action("EliminarEtapa", "Facturacion", "Facturacion") + "?id=" + id;
    swal({
