...
function btnBuscarDocumento_onclick(obj, event) {
    ...
    var url = UrlHelper.Action("AgregarProveedorModal", "Pago", "Pago")
...
{
  var url = UrlHelper.Action("EditarProveedorModal", "Pago", "Pago") + "?id=" + id;
...
{
    var vUrl = UrlHelper.Action("EliminarProveedor", "Pago", "Pago") + "?id=" + id;
