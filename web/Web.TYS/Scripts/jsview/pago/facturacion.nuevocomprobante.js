...
function OnCompleteTransaction(xhr, status)
{
    ...
    if (jsonres.res == true)
    {
       ...
       function ()
       {
            ...
            var url =  UrlHelper.Action ("NuevoComprobante","Facturacion","Facturacion");
   ...
   $("#idtipofacturacion").change(function ()
    {
       ...
       if(val == 99)
       {
           ...
           var url = UrlHelper.Action("ListarMonedaVarios", "Facturacion", "Facturacion");
           $.ajax(
               {
                   type: "POST",
                   async: true,
              ...
              var urlaux = UrlHelper.Action("ListarTipoComprobanteVarios", "Facturacion", "Facturacion");
    ...
    $("#idproveedor").change(function ()
    {
        ...
        var urlinit = UrlHelper.Action ("ListarPlacas","Facturacion","Facturacion");
        ...
        var url = UrlHelper.Action("ListarEtapas", "Facturacion", "Facturacion");
        $.ajax(
               {
                   type: "POST",
                   async: true,
    ...
    $("#idetapa").change(function ()
    {
       ...
       var idproveedor = $("#idproveedor").val();
        var url = UrlHelper.Action("ListarTipoTransporte", "Facturacion", "Facturacion");
        $.ajax(
               {
                   type: "POST",
                   async: true,
     ...
     $("#idtipotransporte").change(function ()
    {
        ...
        var idetapa = $("#idetapa").val();
       var idproveedor = $("#idproveedor").val();
        var url = UrlHelper.Action("ListarTipoComprobante", "Facturacion", "Facturacion");
        $.ajax(
               {
                   type: "POST",
                   async: true,
   ...
   $("#idtipocomprobante").change(function ()
    {
       ...
       var idproveedor = $("#idproveedor").val();
        ...
        var url = UrlHelper.Action("ListarMoneda", "Facturacion", "Facturacion");
        $.ajax(
               {
                   type: "POST",
                   async: true,
...
function cancelar()
{
   ...
   var url = UrlHelper.Action("Comprobante", "Facturacion", "Facturacion") ;
    window.location.href = url;
}