...
var nombre = $('#nombre').val();
    ...
    $(grilla).jqGrid({
        ...
        colNames: ['', 'Código', 'Nombre',  'Acciones' ],
        colModel:
        [
            { key: true, hidden: true, name: 'pag_int_id', index: 'pag_int_id' },
            { key: false, hidden: false, name: 'pag_str_codmenu', index: 'pag_str_codmenu', width: '150', align: 'left' },
               ...
               $.ajax({
                   ...
                   success: function (data) {
                       if (data.res) {
                           ...
                           swal({ title: "Error", text: "No se puede eliminar", type: "error", confirmButtonText: "Aceptar" });
                       }
                   },
                   error: function (data) {
