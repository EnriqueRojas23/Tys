...
function OnCompleteTransaction(xhr, status)
{
    ...
    if (jsonres.res == true)
    {
        ...
        swal("Se actualizó con éxito", "OT: " +  jsonres.ot + " ", "success");
...
function Recalcular()
{
  ...
  if(formula == "")
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe seleccionar una fórmula!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }
  ...
  if(idorigen == "")
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe ingresar un origen!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }
  var iddestino = $('#iddestino').val();
  if(iddestino == "")
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe ingresar un destino!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }
  var idcliente = $('#idcliente').val();
  if(idcliente == "")
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe ingresar un cliente!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }
  var idtipotransporte = $('#idtipotransporte').val();
  if(idtipotransporte == "")
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe ingresar un tipo transporte!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }
 ...
 if(pesogeneral == ""  && volgeneral == "" )
  ...
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe ingresar un peso general!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }

  if(volgeneral.toString() == "")
  {
     swal({ title: "¡Orden Transporte!", text: "¡Debe ingresar un volumen general!", type: "warning", confirmButtonText: "Aceptar" });
     return ;
  }
