...
function OnCompleteTransaction(xhr, status)
{
    ...
    {
        sweetAlert("OT Rápida", jsonres.mensaje, "error");
           ...
           $.ajax(
                {
                 ...
                 success: function (data) {
                       var $select = $('#idformula');
                       $select.empty();
                       $("#idformula").append('<option value="">[--]</option>');
                       $.each(data.listaformula, function (i, state) {
                        ...
                        var $select = $('#idtipotransporte');
                         $select.empty();
                         $("#idtipotransporte").append('<option value="">[--]</option>');
            ...
            $.ajax(
                        {
                         ...
                         success: function (data) {
                          ...
                          $('#idconceptocobro').valid();
                           ...
                           error: function (request, status, error)
                           {
                               swal({ title: "¡Error!", text: "¡Ha ocurrido un error, inténtelo mas tarde!", type: "error", confirmButtonText: "Aceptar" });
                           }
