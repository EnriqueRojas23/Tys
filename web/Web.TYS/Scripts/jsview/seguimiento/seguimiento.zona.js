...
function btnAgregarCliente_onclick(obj, event) {
		...
		var url = UrlHelper.Action("AgregarZonaModal", "Seguimiento", "Seguimiento")
...
{
		var url = UrlHelper.Action("EditarZonaModal", "Seguimiento", "Seguimiento") + "?id=" + id;
		$("#idzona").val(id);
		$.get(url, function (data) {
				$("#modalcontent").html(data);
				$("#modalcontainer").modal("show");
...
function mostrardistritos(id,nombre)
{
		//$("#txtidcliente").val(id);
		 ...
		 $('#idzona').val(id);
		var grilla = $("#griddistritoszona");
		var vdataurl =  UrlHelper.Action("JsonGetListarDistritoxZona", "Seguimiento", "Seguimiento") + "?idzona=" + id;
		 ...
		 $("#idprovincia").change(function ()
				{
						...
						var grilla = $("#griddistritos");
						var vdataurl =  UrlHelper.Action("JsonGetListarDistritos", "Seguimiento", "Seguimiento") + "?idprovincia=" + id;
						$(grilla).jqGrid('setGridParam', { url: vdataurl }).trigger('reloadGrid');
...
function actualizaSeleccion(id , valor)
{
		...
		var vdataurl =  UrlHelper.Action("AgregarDistrito", "Seguimiento", "Seguimiento") + "?iddistrito=" + id;
			$.ajax(
							 {
									 type: "POST",
									 async: true,
...
var idsOfSelectedRows = [41,40,39];
		 ...
		 $("#idprovincia").change(function ()
				{
						...
						var grilla = $("#griddistritoseditar");
						var vdataurl =  UrlHelper.Action("JsonGetListarDistritoxZonaEditar", "Seguimiento", "Seguimiento") + "?idprovincia=" + id+ "&idzona=" + idzona;
						$(grilla).jqGrid('setGridParam', { url: vdataurl }).trigger('reloadGrid');
