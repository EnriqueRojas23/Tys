...
function btnBuscarDocumento_onclick(obj, event) {
    var url = UrlHelper.Action("AgregarValorTablaModal", "Seguimiento", "Seguimiento")
...
function editarvalor(id) {
    var url = UrlHelper.Action("EditarValorTablaModal", "Seguimiento", "Seguimiento") + "?id=" + id;
...
function eliminarvalortabla(id) {
    var vUrl = UrlHelper.Action("EliminarValorTabla", "Seguimiento", "Seguimiento") + "?id=" + id;
    swal({
