...
function configurarGrilla()
{
    ...
    var vdataurl = UrlHelper.Action("JsonListarOTsEntregaFluvial", "Monitoreo", "Monitoreo")
    + "?iddestino=" + iddestino
    ...
    $(grilla).jqGrid({
        ...
        datatype: 'json',
        mtype: 'Post',
        colNames: ['', '', 'Manifiesto', 'OT', 'F. Emisión', 'Entrega', 'F. Entrega', 'H. Entrega'
            , 'F. Despacho', 'H. Despacho', 'Remitente', 'Destinatario', 'Tipo Operación',
            'F. Arribo','F. Conocimiento Embarque','F. Desembarque','F.Embarque','F. Legada Almacén','F. Llegada Puerto','N° Conocimiento',
            'Bultos', 'Peso', 'Volumen', 'Cantidad'],
        colModel:
        [
            ...
            { key: false, hidden: false, editable: false, name: 'fechaarribo', index: 'fechaarribo', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
            { key: false, hidden: false, editable: false, name: 'fechaconocimientoembarque', index: 'fechaconocimientoembarque', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
            { key: false, hidden: false, editable: false, name: 'fechadesembarque', index: 'fechadesembarque', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
            { key: false, hidden: false, editable: false, name: 'fechaembarque', index: 'fechaembarque', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
            { key: false, hidden: false, editable: false, name: 'fechallegadaalmacen', index: 'fechallegadaalmacen', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
            { key: false, hidden: false, editable: false, name: 'fechallegadapuerto', index: 'fechallegadapuerto', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
            { key: false, hidden: false, editable: false, name: 'numeroconocimiento', index: 'numeroconocimiento', width: '90', align: 'center', classes: "grid-col", formatter: 'date', formatoptions: { srcformat: "d/m/Y", newformat: "d/m/Y" }, classes: "grid-col" },
...
function agregarincidentes(id) {
    var vUrl = UrlHelper.Action("JsonAgregarIncidentes", "Monitoreo", "Monitoreo") + "?idsorden=" + id + "&tipoincidencia=MF";
    ...
    $.get(vUrl, function (data) {
        ...
        $("#idmaestroincidencia").change(function () {
        	$.ajax({
        		...
        		type: 'POST',
        		dataType: 'json',
        		data: {idmaestroincidencia:  this.value  , tipoincidencia : "MF" },
        	})
