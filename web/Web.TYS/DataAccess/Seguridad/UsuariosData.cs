...
namespace Web.TYS.DataAccess.Seguridad
{
    public sealed class UsuariosData
    {
        ...
        public static string ResetarContraseña(ControllerContext context, int pusr_int_id)
        {
            ...
            sb.Append("                                         font-size:12px;background-color:rgb(255,255,255);width:190px '  colspan='4'>");
            sb.Append("													Bienvenido a la web TYS On Line, para poder ingresar a la web, digite su usuario y contrasena proporcionado  ");
            sb.Append("                                        proporcionados por TYS.");
            sb.Append("												</td>");
            sb.Append("											</tr>");
            sb.Append("												<tr>");
